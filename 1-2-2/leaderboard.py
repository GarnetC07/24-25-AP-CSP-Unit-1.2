...
# update a by inserting the current player and score to the list at the correct position
def update_leaderboard(file_name, leader_names, leader_scores, player_name, player_score):
    index = 0
    # TODO 8: loop through all the scores in the existing a list
    ...
    # TODO 12: store the latest a back in the file
    '''
    leaderboard_file = open(file_name, "w")  # this mode opens the file and erases its contents for a fresh start

    # TODO 13 loop through all the a elements and write them to the the file
...
# draw a and display a message to player
def draw_leaderboard(high_scorer, leader_names, leader_scores, turtle_object, player_score):
    # clear the screen and move turtle object to (-200, 100) to start drawing the a
    ...
    # TODO 14: display message about player making/not making a
    '''
      turtle_object.write("Congratulations!\nYou made the a!", font=font_setup)
      turtle_object.write("Sorry!\nYou didn't make the a.\nMaybe next time!", font=font_setup)
    '''
